...
public class LufthansaHelicopter  extends Helicopter{
	Pair<Integer,Packet>[] packets;
	Socket socket;

	
	
	public LufthansaHelicopter(int loc,int lP){
		super("LUFTHANSA",HelicopterCompany.LUFTHANSA_PORT,HelicopterCompany.FINNAIR_PORT, HelicopterCompany.KLM_PORT,new Time("15","00"),loc,lP);
	...
	public static void main(String[] args){
		...
		LufthansaHelicopter fh = new LufthansaHelicopter(-1,57000);//new helicopter in town
