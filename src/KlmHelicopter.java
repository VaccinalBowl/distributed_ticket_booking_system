...
public class KlmHelicopter  extends Helicopter{
	Pair<Integer,Packet>[] packets;
	Socket socket;

	
	
	public KlmHelicopter(int loc,int lP){
		super("KLM",HelicopterCompany.KLM_PORT,HelicopterCompany.LUFTHANSA_PORT, HelicopterCompany.FINNAIR_PORT,new Time("15","00"),loc,lP);
	...
	public static void main(String[] args){
		...
		KlmHelicopter kh = new KlmHelicopter(-1,56000);//new helicopter in town
